...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/modelboxs/sub_pool:latest
...
SUB2API_IMAGE=ghcr.io/modelboxs/sub_pool:latest # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
